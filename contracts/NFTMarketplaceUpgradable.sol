...
contract NFTMarketplaceUpgradable is
    Initializable,
    ERC721Upgradeable,
    OwnableUpgradeable,
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC721_init("NFTMarketplaceUUPS", "NMPU");
    ...
    function _baseURI() internal pure override returns (string memory) {
        return
            "https://rose-peculiar-gayal-975.mypinata.cloud/ipfs/QmPehLcz6VfGJGosmYegN2yPhNScXoPvRChLCviN4cqtAi";
    }
